    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageBtn.setOnClickListener( new OnClickListener() {
			public void onClick(View v) {
				String img;
				EditText imgEdit = (EditText) findViewById(R.id.editTextImage);
				img = imgEdit.getText().toString();
				downloadImage(img);			
			}
        });
        ...
        textBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				String txt;
				EditText TxtEdit = (EditText) findViewById(R.id.editTextTxt);
				txt = TxtEdit.getText().toString();
				downloadText(txt);
			}
        });
    }
